#!/usr/bin/env bash
# Runs the outbound real-estate (Canopy) vertical under its own agent_name,
# for side-by-side demo use with run-clinic-agent.sh — run whichever
# vertical you want to demo, or both at once under different agent_names.
#
...
export VERTICAL="canopy"
export AGENT_NAME="the-canopy-agent"
