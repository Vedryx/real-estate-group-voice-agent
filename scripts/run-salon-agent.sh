#!/usr/bin/env bash
# Runs the inbound salon-appointment vertical under its own agent_name, for
# side-by-side demo use with run-canopy-agent.sh / run-clinic-agent.sh — run
# whichever vertical you want to demo, or several at once under different
# agent_names.
#
...
export VERTICAL="salon"
export AGENT_NAME="the-salon-agent"
